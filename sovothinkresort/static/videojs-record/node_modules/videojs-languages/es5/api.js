 ...
 */
var convert = function convert(patterns, dir) {
  var srces = (0, _lib.findSources)((0, _lib.normalizePatterns)(patterns));
  var dests = (0, _lib.processSources)(srces, (0, _lib.normalizeDir)(dir));

  return { srces: srces, dests: dests };
};
